...
class UserController extends Controller
{
    public function index()
    {
        ...
        $active = 'user';
        return view('user.index', compact('notif1','active'));
    }
    ...
    public function profil()
    {
        ...
        $active = 'user-profil';
        $profil = auth()->user();
        return view('user.profil', compact('profil','notif1','active'));
    }
    ...
    public function updateProfil(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'foto' => 'image|file|max:1000'
        ]);
        
        if ($validator->fails()) {
            return response()->json('Foto harus berupa image dan tidak boleh lebih dari 1 Mb.', 422);
        } else {
