...
{ 
    public function index()
    {
        ...
        $active = 'penjualan_detail';
        $produk = toko::orderBy('nama_produk')->get();
        ...
        if ($id_penjualan = session('id_penjualan')) {
            ...
            return view('penjualan_detail.index', compact('notif1','active','produk', 'member', 'diskon', 'id_penjualan', 'penjualan', 'memberSelected'));
        } else {
