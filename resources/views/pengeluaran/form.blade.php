        ...
        <form action="{{ route('pengeluaran.store') }}" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-control" style="padding: 0%">
                                <select class="form-control select2" name="nama_produk" style="width: 100%;" required autofocus>
                    ...
                    <div class="form-group row">
                        <label for="deskripsi" class="col-lg-2 col-lg-offset-1 control-label">Jumlah Produk</label>
                        <div class="col-lg-6">
                            <input type="number" name="jumlah_produk" id="deskripsi" class="form-control" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <input type="hidden" name="id_pengeluaran" id="">
